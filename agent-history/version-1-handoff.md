...
- Preflight completed: `[YES | NO]` - `[SUMMARY]`
- Expected files matched actual changes: `[YES | NO]` - `[DETAILS]`
- Context refresh performed: `[YES | NO | NOT_REQUIRED]` - `[SUMMARY]`
- Dumb-zone triggered: `[NO | YES]` - `[TRIGGER_OR_N/A]`
- Recovery summary: `[SUMMARY_OR_N/A]`
- Unsupported assumptions remaining: `[NONE_OR_ITEMS]`
